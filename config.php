...
define('MAPOTEMPO_URL_API_CUSTOMER', 'http://localhost:3000/api/0.1/customers/');
define('MAPOTEMPO_URL_API_USER', 'http://localhost:3000/api/0.1/users');

define('MAPOTEMPO_TEMPLATE_ID_FR', 3);
